...
# if aa:
    ...
    if pred_res == 1:
        ...
        pred_res = "Identified Suspicious = ABUSE"
        ...
        st.markdown(f'<h1 style="color:#000000;text-align: center;font-size:48px;">{" Identified Suspicious = ABUSE "}</h1>', unsafe_allow_html=True)
        ...
        # print("-----------------------------")
        # print("Weapon --> Gun")
        pred_res ="Identified Suspicious = ARREST"
        ...
        st.markdown(f'<h1 style="color:#000000;text-align: center;font-size:28px;">{" Identified Suspicious = ARREST "}</h1>', unsafe_allow_html=True)
        ...
        # print("-----------------------------")
        # print("Weapon --> fire ")
        pred_res ="Identified Suspicious = ARSON"
        ...
        st.markdown(f'<h1 style="color:#000000;text-align: center;font-size:28px;">{" Identified Suspicious = ARSON "}</h1>', unsafe_allow_html=True)
        ...
        pred_res ="Identified Suspicious = EXPLOSION"
        ...
        st.markdown(f'<h1 style="color:#000000;text-align: center;font-size:28px;">{" Identified Suspicious = EXPLOSION "}</h1>', unsafe_allow_html=True)
        ...
        st.markdown(f'<h1 style="color:#000000;text-align: center;font-size:28px;">{" Identified Suspicious = SHOPLIFTING "}</h1>', unsafe_allow_html=True)
        ...
        pred_res ="Identified Suspicious = ROAD ACCIDENTS"
        ...
        st.markdown(f'<h1 style="color:#000000;text-align: center;font-size:28px;">{" Identified Suspicious = ROAD ACCIDENTS "}</h1>', unsafe_allow_html=True)
